...
HD_PWD='C:/Users/HP/Desktop/Nano_Final/Nano/Nano.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Final_Project.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Final_Project.tcl -notrace
